...
diccionario de internacionalizacion.
    ...
    Diccionario-i18n-Torres.xlsx  (hoja Diccionario)
        |
...
XLSX = os.path.join(RAIZ, "Diccionario-i18n-Torres.xlsx")
PROYECTO = os.path.join(RAIZ, "code", "src", "Torres.Client")
...
# el patron de cada una. Ver Analisis-Auditoria-Diccionario-i18n-Torres.md.
PANTALLAS_EXCLUIDAS = {"Formats"}

CABECERA_RESX = """<?xml version="1.0" encoding="utf-8"?>
<!--
  Generado por code/tools/generar-recursos.py a partir de Diccionario-i18n-Torres.xlsx.
